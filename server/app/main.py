...
from app.routers import auth, challenges, feed, friends, me, notifications, room_equip, room_speech, shop, users, verifications
...
app.include_router(room_speech.router, prefix=settings.API_V1_PREFIX)
