...
def upgrade() -> None:
    ...
    op.create_unique_constraint("uq_room_speeches_member", "room_speeches", ["challenge_id", "user_id"])
    op.create_index("ix_room_speeches_challenge_expires", "room_speeches", ["challenge_id", "expires_at"])
